# =============================================================================
# src/data_loader.py — NASA Data Ingestion & Light Curve Preprocessing
#
# Pipeline overview:
...
def fetch_koi_catalog(max_rows: int = 5000) -> pd.DataFrame:
    """
...
def preprocess_light_curve(
    ...
    try:
        ...
        # Force plain numpy array — astropy binning can return masked arrays
        return np.array(flux_norm, dtype=np.float32)
...
def build_dataset(max_kois: int = 5000, force_rebuild: bool = False):
    """
